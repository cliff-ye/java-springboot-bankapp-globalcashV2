...
<html lang="en">
  <head>
    ...
    <title>globalCash| Banking made easy</title>
        ...
        <nav id="navbar" class="navbar navbar-dark navbar-expand-md">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li>
                <a class="getstarted scrollto" href="/reguser"
                  >Register</a
                >
              </li>
            </ul>
      ...
      <div class="container">
        <div class="row">
          <div
            ...
            data-aos-delay="200"
          >
            <h1>Better Banking Experience Anywhere In The World</h1>
            <h2>
              Welcome to globalcash where you enjoy a simple and secured banking
          ...
          >
            <img
              src="assets/images/undraw_adventure_re_ncqp.svg"
